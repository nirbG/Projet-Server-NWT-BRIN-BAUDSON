...
let ComicsDao = class ComicsDao {
    constructor(_comicsModel) {
        this._comicsModel = _comicsModel;
    }
    find() {
...
ComicsDao = __decorate([
    common_1.Injectable(),
    __param(0, mongoose_1.InjectModel('Comics')),
    __metadata("design:paramtypes", [mongoose_2.Model])
], ComicsDao);
exports.ComicsDao = ComicsDao;
//# sourceMappingURL=comics.dao.js.map