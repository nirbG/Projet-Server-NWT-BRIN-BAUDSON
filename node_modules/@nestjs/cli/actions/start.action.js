...
class StartAction extends build_action_1.BuildAction {
    handle(inputs, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const configuration = yield this.loader.load();
                ...
                const onSuccess = this.createOnSuccessHook(configuration, appName, debugFlag, outDir);
                yield this.runBuild(inputs, options, isWatchEnabled, !!debugFlag, onSuccess);
            }
            catch (err) {
    ...
    createOnSuccessHook(configuration, appName, debugFlag, outDirName) {
        ...
        return () => {
            if (childProcessRef) {
                ...
                childProcessRef.on('exit', () => {
                    childProcessRef = this.spawnChildProcess(entryFile, sourceRoot, debugFlag, outDirName);
    ...
    spawnChildProcess(entryFile, sourceRoot, debug, outDirName) {
        ...
        return child_process_1.spawn('node', processArgs, {
            stdio: 'inherit',
            shell: true,
        });
    }
